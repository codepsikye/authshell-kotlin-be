...
interface AppUserRoleRepository : JpaRepository<AppUserRole, AppUserRole.AppUserRoleId> {
    ...
    fun findCenterIdsByUserId(userId: Int): List<Int>
    ...
    fun hasUniqueCenterId(userId: Int): Boolean
    ...
    fun getUniqueCenterId(userId: Int): Int?
    ...
    fun findRoleNamesByUserIdAndCenterId(userId: Int, centerId: Int): List<String>
    ...
    fun findAccessRightsByUserIdAndCenterId(userId: Int, centerId: Int): List<List<String>>
}